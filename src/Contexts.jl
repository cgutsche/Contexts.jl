...
export addContext, getActiveContexts, isActive, activateContext, deactivateContext, deactivateAllContexts, addMixin, addTeam, getTeam, getRoles, getObjectOfRole, hasRole, getTeamPartners, getContexts, getMixins, getMixin, getRole, @newContext, @newTeam, @newMixin, @context, @assignRoles, <<, >>, assignRoles, disassignRoles, assignMixin, disassignMixin, Context, Mixin, Role, Team, AndContextRule, OrContextRule, NotContextRule, reduceRuleToElementary, getCDNF
