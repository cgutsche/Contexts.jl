...
export addContext, getActiveContexts, isActive, activateContext, deactivateContext, deactivateAllContexts, addMixin, addTeam, getTeam, getDynamicTeam, getDynamicTeams, getRoles, getObjectOfRole, getDynamicTeamID, getObjectsOfRole, hasRole, getTeamPartners, getContexts, getMixins, getMixin, getRole, @newContext, @newTeam, @newMixin, @team, @context, @activeContext, @assignRoles, @disassignRoles, @changeRoles, @newDynamicTeam, <<, >>, changeRoles, assignRoles, disassignRoles, assignMixin, disassignMixin
